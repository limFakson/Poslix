<?php
    ...
    use Modules\Ecommerce\Http\Controllers\QrCodeController;
	...
	if(config('database.connections.saleprosaas_landlord')) {
    	Route::middleware(['common', 'auth', 'active', InitializeTenancyByDomain::class,PreventAccessFromCentralDomains::class])->group(function () {
            ...
            // Route::get('/main', [FrontController::class, 'main']);
            //Appearance
            Route::prefix('appearance')->group(function () {
                Route::post('design', [AppearanceController::class, 'designpost'])->name('appearance.designpost');
                Route::get('menu', [AppearanceController::class, 'menu'])->name('appearance.menu');
                Route::post('menu', [AppearanceController::class, 'menupost'])->name('appearance.menuposts');
            });

            Route::prefix('digital-menu')->group(function () {
                Route::get('setting/order', [OrderController::class, 'orderSetting'])->name('setting.order');
                Route::get('appearance/design', [AppearanceController::class, 'design'])->name('appearance.design');
                Route::get('/generate-qr', [QrCodeController::class, 'showForm'])->name('show.qr.form');
            });

            //Order route
	        Route::post('setting/order', [OrderController::class, 'orderSettingStore'])->name('setting.orderStore');
    	...
    	Route::middleware(['ecommerce', InitializeTenancyByDomain::class,PreventAccessFromCentralDomains::class])->group(function () {
    		...
    		Route::get('/', [FrontController::class, 'index'])->name('ecommerce.home');
    		Route::get('/main', [FrontController::class, 'main']);
