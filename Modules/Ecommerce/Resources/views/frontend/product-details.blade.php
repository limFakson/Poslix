...
<script type="text/javascript">
 ...
 <script>
        $(document).ready(function() {
            // Assuming $extraCategories contains the data in the specified format
            var $extraCategories = [{"id":1,"category_name":"Add-ons","is_multi":1,"created_at":"2024-04-21T17:01:42.000000Z","updated_at":"2024-04-21T17:01:42.000000Z"},{"id":2,"category_name":"Extra","is_multi":0,"created_at":"2024-04-23T11:16:32.000000Z","updated_at":"2024-04-23T11:16:32.000000Z"},{"id":3,"category_name":"CHEEZY","is_multi":1,"created_at":"2024-04-30T12:14:14.000000Z","updated_at":"2024-04-30T12:14:14.000000Z"}];

            // Iterate over the $extraCategories array
            $extraCategories.forEach(function(category) {
                // Check if it's a multi-select category or not
                var inputType = category.is_multi ? 'checkbox' : 'radio';

                // Create the checkbox or radio input element
                var inputElement = $('<input>', {
                    type: inputType,
                    name: 'extras[]',
                    value: category.id // Assuming category ID is used as value
                });

                // Create the label for the input element
                var labelElement = $('<label>').text(category.category_name);

                // Append the input and label to the item description container
                $('.item-addon').append(inputElement, labelElement);
            });

            // Event listener for changes in checkboxes or radio buttons
           $('body').on('change', 'input[type="checkbox"][name="extras[]"], input[type="radio"][name="extras[]"]', function() {
