...
class OrdersController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if(auth()->user())
        {
            ...
            $checkout_name = $post_data['shipping_name']??'Guest';
            $checkout_email = $post_data['shipping_email']??'guest@customer.com';
            $checkout_phone_number = $post_data['shipping_phone']??12345678;
            $checkout_address = $post_data['shipping_address']??'';
            $checkout_city = $post_data['shipping_city']??'';
            ...
            $customer = Customer::firstOrCreate(
                ...
                ['name' => $checkout_name, 'phone_number' => $checkout_phone_number, 'address' => $checkout_address, 'city' => $checkout_city, 'customer_group_id' => 1]
            );
        ...
        $post_data['order_type'] = trim(htmlspecialchars($request->input('order_type')));
