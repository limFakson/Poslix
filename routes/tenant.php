...
use App\Http\Controllers\MenuPaymentSettingController;
...
Route::group(['middleware'=>['web', InitializeTenancyByDomain::class,PreventAccessFromCentralDomains::class] ], function () {
        ...
        Route::get('view/sales/{id}', [SaleController::class,  'genInvoiceView'])->name('sale.viewinvoice');
        ...
        Route::group(['middleware' => ['common', 'auth', 'active']], function() {
            ...
            Route::controller(ProductController::class)->group(function () {
                Route::get('extra', 'extra')->name('extra');
                Route::post('extra/extra-data', 'extraData');
                ...
                Route::get('products/{id}/edit', 'edit')->name('productsedit');
                ...
                Route::get('/extra-categories','extraCategories')->name('product.extra.categories');
             });
            ...
            Route::controller(SaleController::class)->group(function () {
                ...
                Route::get('sales/sendsms/{id}', 'sendsms')->name('sale.sendsms');
                Route::get('sales/sendwp/{id}', 'sendwp')->name('sale.sendwp');
            ...
            Route::controller(SettingController::class)->group(function () {
                Route::prefix('setting')->group(function () {
                    ...
                    Route::post('add_action_button', 'addActionButton')->name('setting.addActionButton');
                    Route::post('status_action_button/{id}', 'changeStatusActionButton')->name('setting.changeStatusActionButton');
                    Route::post('update_action_button/{id}', 'updateActionButton')->name('setting.updateActionButton');
                    Route::delete('delete_action_button/{id}', 'deleteActionButton')->name('setting.deleteActionButton');

                    Route::post('general_setting_store', 'generalSettingStore')->name('setting.generalStore');
                    Route::post('custom_method_store', 'custom_method_store')->name('setting.custom_method_store');
                    ...
                    Route::get('settingsmswhatsapp_setting', 'smswhatsapp_setting')->name('setting.smswhatsapp_setting');
                    Route::post('settingsmswhatsapp_setting_store', 'settingsmswhatsapp_setting_store')->name('setting.settingsmswhatsapp_setting_store');
                    ...
                    Route::get('pos_setting_custom_method_delete/{id}', 'pos_setting_custom_method_delete')->name('setting.pos_setting_custom_method_delete');
                    Route::post('working_hours_setting', 'workinghoursSetting')->name('setting.working_hours_store');
                    Route::get('empty-database', 'emptyDatabase')->name('setting.emptyDatabase');

                    Route::post('menu-payment-create', 'menu_payment_create')->name('menu.payment.create');

                 });
                 Route::prefix('digital-menu')->group(function () {
                    Route::get('payment-settings', 'menu_payment_view')->name('menu.payment');
                    Route::get('working_hours_setting', 'workinghours')->name('setting.working_hours');
                    Route::get('action_buttons', 'action_buttons')->name('setting.actionButtons');
                });
