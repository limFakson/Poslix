        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            @if ($all_notification_permission_active)
                <li id="menu-notification">
                    <a href="{{ route('notifications.menu') }}"><i
                            class="dripicons-bell"></i><span>{{ trans('file.Menu Notification') }}</span></a>
                </li>
            @endif

            <li><a href="#dmsetting" aria-expanded="false" data-toggle="collapse"> <i
                        class="dripicons-gear"></i><span>{{ trans('file.Digital Menu settings') }}</span></a>
                <ul id="dmsetting" class="collapse list-unstyled ">
                    <?php
                    $pos_setting_permission_active = $role_has_permissions_list->where('name', 'pos_setting')->first();
                    ?>
                    <li id="order-digital-menu"><a href="{{ route('setting.order') }}">Order
                            {{ trans('file.settings') }}</a></li>
                    @if ($pos_setting_permission_active)
                        <li id="payment-digital-menu"><a href="{{ route('menu.payment') }}">Payment
                                {{ trans('file.settings') }}</a></li>
                    @endif
                    <li id="appearance-digital-menu"><a href="{{ route('appearance.design') }}">Appearance
                            {{ trans('file.settings') }}</a></li>
                    <li id="qr-digital-menu"><a href="{{ route('show.qr.form') }}">QR {{ trans('file.code') }}</a>
                    </li>
                    <li id="button-digital-menu"><a href="{{ route('setting.actionButtons') }}">Action
                            {{ trans('file.button') }}</a></li>
                    <li id="whours-digital-menu"><a
                            href="{{ route('setting.working_hours') }}">{{ trans('file.Working Hours') }}</a></li>
                </ul>
            </li>
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @endif
                    <li id="whatsapp-sms-menu"><a
                            href="{{ route('setting.smswhatsapp_setting') }}">{{ __('SMS/Whatsapp Setting') }}</a>
                    </li>
                    ...
                    @endif
                    @if ($pos_setting_permission_active)
                        <li id="order-setting-menu"><a href="{{ route('setting.order') }}">Order
                                {{ trans('file.settings') }}</a></li>
                    @endif
                    @if ($pos_setting_permission_active)
                        <li id="order-setting-menu"><a
                                href="{{ route('setting.working_hours') }}">{{ trans('file.Working Hours') }}</a>
                        </li>
                    @endif
                    ...
                    @endif
                    <li id="action_buttons"><a href="{{ route('setting.actionButtons') }}"> Action Buttons</a></li>
                    <li id="languages"><a href="{{ url('languages/') }}"> {{ trans('file.Languages') }}</a></li>
                </ul>
            </li>
            @if (Auth::user()->role_id != 5)
                <li><a href="#documentation" aria-expanded="false" data-toggle="collapse"> <i
                            class="dripicons-information"></i><span>{{ trans('file.Documentation') }}</span></a>
                    <ul id="documentation" class="collapse list-unstyled ">
                        <li><a target="_blank" href="{{ url('/documentation') }}"><span>Poslix</span></a></li>
                        <li><a target="_blank" href="{{ url('/ecommerce-documentation') }}"><span>Poslix
                                    eCommerce</span></a></li>
                    </ul>
                </li>
            @endif
