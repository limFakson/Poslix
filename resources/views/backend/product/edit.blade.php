      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">{{trans('file.Update Product')}}</h1>
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-4">
                      <label>{{ trans('file.Product Second Name') }} </label>
                                        <input type="text" name="sec-name" class="form-control" id="sec-name"
                                        value="{{$lims_product_data->second_name}}">
                                        <span class="validation-msg" id="name-error"></span>
                ...
                <div class="mb-4">
                  @if($extraCategories)
                                ...
                                <div class="form-group col-12">
                                    <label>{{ trans('Extra Categories') }} </strong> </label>
                                    <div class="input-group">
                                        <select class="form-control" multiple
                                            id="extra_categories[]" name="extra_categories[]">
                                            @foreach ($extraCategories as $extraCategory)
                                            <option value="{{$extraCategory->id}}"
                                            @if(in_array($extraCategory->id, $selectedCategories)) selected @endif
                                                >{{$extraCategory->category_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
