@extends('backend.layout.main')
   @section('head')
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{ asset('vendor.min.css') }}">
          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" >Products</a></li>
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                 <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <label for="productNameLabel" class="form-label">{{trans('file.Product Type')}} *</label>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <!-- Form -->
                    <div class="mb-4">
                      <label class="form-label">{{trans('file.Product Code')}} *</label>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-4">
                      <label class="form-label">{{trans('file.Barcode Symbology')}} *</label>

                      <div class="" style="width: 100% important;">
                        <div class="">
                          <!-- Select -->
                          <div class="tom-select-custom">
                            <select class="form-control selectpicker" name="barcode_symbology" required  >
                  ...
                  <div class="col-sm-6" id="digital">
                    <div class="mb-4">
                      <label class="form-label">{{ trans('file.Attach File') }}  </label>
                      <div class="input-group">
                  ...
                  <div class="col-sm-10" id="combo">
                    <div class="mb-4">
                      <label class="form-label">{{ trans('file.add_product') }}</label>
                      <div class="search-box input-group mb-3">
                          <button class="btn btn-secondary"><i class="fa fa-barcode"></i></button>
                          <input type="text" name="product_code_name" id="lims_productcodeSearch"
                              placeholder="Please type product code and select..." class="form-control" />
                      </div>
                      <label class="form-label">{{ trans('file.Combo Products') }}</label>
                          ...
                          <table id="myTable" class="table table-hover order-list">
                              <thead>
                                  <tr>
                                      ...
                                      <th><i class="fa-solid fa-trash " style="font-size: 18px;"></i></th>
                                  </tr>
                              </thead>
                              <tbody>
                              </tbody>
                    ...
                    <div class="mb-4">
                      <div class="row ">
                        <div class="col-md-6 form-group">
                            <div class="mb-4">
                              <label class="form-label ">{{ trans('file.Product Unit') }} * </label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6">
                           <div class="mb-4">
                            <label class="form-label ">{{ trans('file.Sale Unit') }} </label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                <label class="form-label ">{{ trans('file.Purchase Unit') }} </label>
                                <div class="input-group">
          ...
          <div class="col-lg-4">
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div id="cost">
                  <div class="mb-4">
                    <label class="form-label ">{{ trans('file.Product Cost') }}</label>
                ...
                <div class="mb-4">
                  <label class="form-label ">{{trans('file.Product Price')}} * </label>
               ...
               <div class="mb-4">
                ...
                <div class="mb-4" id="alert-qty">
                  <label class="form-label ">{{trans('file.Alert Quantity')}}</strong> </label>
                                        <input type="number" name="alert_quantity" class="form-control" step="any">
                </div>

                <div class="mb-4">
                  <label class="form-label ">{{trans('file.Product Tax')}}</strong> </label>
                                        <select class="form-control selectpicker"  name="tax_id" >
                ...
                <div class="mb-4">
                  <label class="form-label ">{{trans('file.Tax Method')}}</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Exclusive: Poduct price = Actual product price + Tax. Inclusive: Actual product price = Product price - Tax')}}"></i>
                                        <select class="form-control selectpicker" name="tax_method" >
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                  <label class="form-label ">{{ trans('file.category') }} * </label>
                  <div class="input-group">
                  ...
                  @if ($extraCategories)
                                        ...
                                        <label class="form-label ">{{ trans('Extra Categories') }}  </label>
                                            ...
                                            <select class="form-control selectpicker" multiple id="extra_categories[]"
                                                ...
                                                @foreach ($extraCategories as $extraCategory)
                                                    <option value="{{ $extraCategory->id }}">
                                                        {{ $extraCategory->category_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-12 mt-3">
                                        <div class="form-group">
                                            <label class="form-label ">{{ trans('file.Product Tags') }}</strong> </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @elseif($field->type == 'textarea')
                                                    <textarea rows="5" name="{{ str_replace(' ', '_', strtolower($field->name)) }}"
                                                        value="{{ $field->default_value }}" class="form-control"
                                                        @if ($field->is_required) {{ __('required') }} @endif></textarea>
...
<script type="text/javascript">
        ...
        // Add an event listener to update the meta_description and meta_title values
        nameInput.addEventListener('input', function() {
            metaDescriptionInput.value = nameInput.value;
                        ...
                        if (myDropzone.getAcceptedFiles().length) {
                            ...
                            $.ajax({
                                ...
                                error: function(response) {
                                    $('#submit-btn').removeAttr('disabled', 'false').html(
                                        '<span></span>{{ trans('file.add_product') }}...'
                                    );
...
@section('scripts')
    ...
    <script src="{{ asset('vendor.min.js') }}"></script>
    <script src="{{ asset('theme.min.js') }}"></script>
@endsection
