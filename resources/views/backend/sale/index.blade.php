                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select id="sale-type" class="form-control" name="sale_type">
                                ...
                                <option value="webpos">{{trans('file.WebPos')}}</option>
                                <option value="online">{{trans('file.Online')}}</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var columns = [{"data": "key"}, {"data": "date"},{"data": "time"}, {"data": "reference_no"}, {"data": "biller"}, {"data": "customer"}, {"data": "sale_type","render": function(data, type, row){return data? data : "N/A";}}, {"data": "sale_status"}, {"data": "payment_status"}, {"data": "delivery_status"}, {"data": "grand_total"}, {"data": "returned_amount"}, {"data": "paid_amount"}, {"data": "due"}];
    ...
    $('#sale-table').DataTable( {
        ...
        'columnDefs': [
            ...
            { "visible": false, "targets": [ 4, 9, 11, 13 ] }
        ],
