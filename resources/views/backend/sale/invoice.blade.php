            ...
            <div class="hidden-print">
                <table>
                    <tr>
                        ...
                        @if ($wssetting)
                            @if ($wssetting->whatsapp == 1)
                                <td><a href="{{ $urlw }}" class="btn btn-success"><i
                                            class="fa fa-arrow-left"></i> Share</a> </td>
                            @endif
                        @endif
                    </tr>
                </table>
            ...
            <div class="centered">
                @if ($general_setting->site_logo)
                    <img src="{{ url('logo', $general_setting->site_logo) }}"
                        style="max-width: 50%; max-height: 100%; margin:10px 0;">
                @endif
                ...
                <tbody>
                    ...
                    @foreach ($lims_product_sale_data as $key => $product_sale_data)
                        ...
                        if (!is_null($product_sale_data->extra_names)) {
                            ...
                            foreach ($product_sale_data->extra_names as $key => $value) {
                                $product_name .= '<br>' . $value;
                                # code...
                            }
                        }
                        ?>
