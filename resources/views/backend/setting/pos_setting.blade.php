...
<section class="forms">
                        ...
                        {!! Form::open(['route' => 'setting.posStore', 'method' => 'post']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3 d-flex">
                                    ...
                                    <button type="button" class="btn btn-success ml-auto" data-toggle="modal" data-target="#methodModal">
                                ...
                                <div class="col-md-12 d-flex ">
                                    @foreach ($methods as $method)
                                        <div class="form-group d-inline col-md-2 d-flex">
                                            <div>
                                                @if($method->active == 1)
                                                <input class="mt-2" type="checkbox" name="coptions[]" value="{{$method->id}}" checked>
                                                @else
                                                <input class="mt-2" type="checkbox" name="coptions[]" value="{{$method->id}}">
                                                @endif
                                                <label class="mt-2"><strong>{{$method->name}}</strong></label>
                                            </div>
                                            <div class="float-right ml-auto">
                                                    <a href="{{route('setting.pos_setting_custom_method_delete', $method->id)}}" class="btn btn-sm btn-danger">
    ...
    <div class="modal fade" id="methodModal" tabindex="-1" role="dialog" aria-labelledby="methodModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <form action="{{route('setting.custom_method_store')}}" method="post">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="methodModalLabel">Create Custom Payment Method</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="method_id">Method Title</label>
                        <input type="text" class="form-control" id="method_id" aria-describedby="customMethod" placeholder="Enter title" required name="title">
                        <small id="customMethod" class="form-text text-muted">Enter new title</small>
                      </div>
                </div>
