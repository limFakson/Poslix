...
@php
    ...
    Log::info('Landlord Auth SignUp Balde Php FIle');
    Log::info($request);
    Log::info($terms_and_condition_page);
@endphp
        ...
        <div class="container">
            <div class="main-header">
                <div class="header-left">
                    <div class="header-logo"><a class="d-flex" href="https://neroon.co/"><img alt="NEROON"
                                src="landlord/custom/assets/imgs/template/logo.png"></a></div>
                ...
                <div class="header-right">
                    <div class="block-signin"><a class="btn btn-default hover-up icon-arrow-right"
                            href="page-signup.html">14 JOURS D'ESSAI</a></div>
                </div>
            </div>
        </div>
    </header>
        ...
        <section class="section-box">
            <div class="bg-6-opacity-30 pt-90">
                <div class="container">
                    <div class="box-signup">
                        ...
                        <div class="text-center">
                            <div class="mt-40 box-line-throught mb-40"><span
                                    class="text-body-text color-gray-500">Innovation, efficacité et productivité</span>
                            </div>
                        </div>
                        <form action="{{ route('tenant.checkout') }}" method="POST"
                            class="form row customer-signup-form">
                            @csrf
                            <div class="box-form-signup mb-200">
                                ...
                                <input type="hidden" name="subscription_type"
                                    value="{{ $request->subscription_type }}">
                                <input type="hidden" name="price" value="{{ $request->price }}">
                                <div class="form-group"><input required name="company_name" class="form-control"
                                        placeholder="Nom de l'entreprise *">
                                </div>
                                <div class="form-group">
                                    <input required name="email" class="form-control"placeholder="Votre email *">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input required name="tenant"
                                        class="form-control"placeholder="{{ 'your_sub_domain@' . env('CENTRAL_DOMAIN') }}">
                                </div>
                                @if ($terms_and_condition_page)
                                    <div class="form-group">
                                        <label class="text-body-small color-gray-500">
                                            <input required class="chkbox" type="checkbox"> Acceptez
                                            <a href="{{ url('page/' . $terms_and_condition_page->slug) }}">
                                ...
                                <div class="form-group"><button
                                        class="btn btn-green-full text-heading-6">Soumettre</button></div>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="images-lists">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-6 pl-0"><img class="img-responsive img-full img-1"
                                src="public/landlord/custom/assets/imgs/template/img-1.png" alt="Agon"></div>
                        <div class="col-lg-2 col-md-2 col-sm-6"><img class="img-responsive img-full img-2"
                                src="public/landlord/custom/assets/imgs/template/img-2.png" alt="Agon"></div>
                        <div class="col-lg-4 col-md-4 col-sm-12"><img class="img-responsive img-full img-3"
                                src="public/landlord/custom/assets/imgs/template/img-3.png" alt="Agon"></div>
                        <div class="col-lg-2 col-md-2 col-sm-6"><img class="img-responsive img-full img-4"
                                src="public/landlord/custom/assets/imgs/template/img-4.png" alt="Agon"></div>
                        <div class="col-lg-2 col-md-2 col-sm-6 pr-0"><img class="img-responsive img-full img-5"
                                src="public/landlord/custom/assets/imgs/template/img-5.png" alt="Agon"></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="footer-bottom mt-20">
                <div class="row">
                    <div class="col-md-6"><span class="color-gray-400 text-body-lead">&copy; NEROON</span>
                        <div class="footer-social"><a class="icon-socials icon-facebook"
                                href="https://www.facebook.com/nneroon" target="_blank"></a><a
                                class="icon-socials icon-twitter" href="https://twitter.com/Neroonn_"
                                target="_blank"></a><a class="icon-socials icon-instagram"
                                href="https://www.instagram.com/neroonn_/" target="_blank"></a><a
                                class="icon-socials icon-linkedin" href="https://www.linkedin.com/company/neroon/"
                                target="_blank"></a></div>
                    </div>
                </div>
            </div>
